...
func (tsp *TransformSourceProps) inoutForSrc(relSrc, srcDir, genDir string) (io inout) {
	...
	if tsp.Out.Depfile != "" {
		io.depfile = filepath.Join(genDir, re.ReplaceAllString(relSrc, tsp.Out.Depfile))
	}
